...
function homeView() {
    ...
    contentPanel.innerHTML = `
        <h3>Come plan the future of<br><span style="font-size: 1.5em;">Tekong New Town!</span></h3>
        <div class="image-container">
            <img src="./assets/images/hdb3.png" alt="HDB Image" id="hdb-image" class="img-fluid">
        </div>
